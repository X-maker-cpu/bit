...
const Videocomponent = () => {
  return (
    <Box>
      ...
      >
        <Image src="https://images.pexels.com/photos/750539/pexels-photo-750539.jpeg?auto=compress&cs=tinysrgb&w=600" height={400} width={500} />
        <Image src="https://images.pexels.com/photos/6480239/pexels-photo-6480239.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" height={400} width={500}></Image>
        <Typography
          varaint="caption"
          sx={{
            position: "absolute",
      ...
      {/*Author Avatar, video Title and Name */}
      <Box sx={{ display: "flex" }}>
        <Avatar />
      </Box>
      <Typography variant="body1">Zebra</Typography>
