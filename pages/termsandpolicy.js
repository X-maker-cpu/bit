...
<Typography variant="h5" color="black" fontFamily="serif"  >1. Terms of service:</Typography>
...
<Typography variant="h5" color="black"  fontFamily="serif" >Cookies </Typography>
<Box sx={{marginLeft:9}}>
<Typography variant="h6" color="text.secondary" fontFamily="serif">
...
<br/><br/><br/><br/>
<Typography variant="h5" color="black"  fontFamily="serif">Our Service</Typography>
...
<br/><br/><br/><br/>
<Typography variant="h5" color="black" fontFamily="serif">Your Service Provider</Typography>
<Box sx={{marginLeft:9}}><Typography variant="h6" color="text.secondary" fontFamily="serif">The entity providing the Service is Google LLC,  a company operating under the laws of Delaware, located at 1600 Amphitheatre Parkway, Mountain View, CA 94043 ('&apos;'referred to as BIT, we, us, or our').  References to BIT's “Affiliates” in these terms means the other companies within the Alphabet Inc. corporate group.</Typography></Box>
<br/><br/><br/><br/> 
<Typography variant="h5" color="black"  fontFamily="serif">Applicable Terms</Typography>
<Box sx={{marginLeft:9}}><Typography variant="h6" color="text.secondary" fontFamily="serif">Your use of the Service is subject to these terms, the BIT Community Guidelines and the Policy, Safety and Copyright Policies ('&quot;'together, the Agreemen'). Your Agreement with us will also include the Advertising on BIT Policies if you provide advertising or sponsorships to the Service or incorporate paid promotions in your Content.</Typography></Box>
<br/><br/><br/><br/>
...
<Typography variant="h6" color="black"  fontFamily="serif">Rights you Grant</Typography>
...
<Typography variant="h6" color="black"  fontFamily="serif">Licence to BIT</Typography>
...
<br/><br/><br/>
<Typography variant="h6" color="black"  fontFamily="serif">Downloadable Software</Typography>
...
<br/><br/><br/>
<Typography variant="h6" color="black"  fontFamily="serif">Warranty</Typography>
...
<br/><br/><br/>
<Typography variant="h6" color="black"  fontFamily="serif">Disclaimer</Typography>
...
<br/><br/><br/>
<Typography variant="h5" color="black"  fontFamily="serif">Third Party Links</Typography>
...
<br/><br/><br/>
<Typography variant="h5" color="black"  fontFamily="serif">About this Agreement</Typography>
