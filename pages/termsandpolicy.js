...
<Typography variant="h6" color="text.secondary" fontFamily="serif">
    <ul>
    <li>Acceptance of Terms and Conditions: These terms and conditions constitute a legal agreement between you and BIT regarding your use of our services in connection with the design and development of a BIT clone. By using our services, you agree to be bound by these Terms.</li>
        <br/>
    <li>Ownership of Intellectual Property: You acknowledge that we own all right, title, and interest in and to the Project, including all intellectual property rights therein. You agree not to use or disclose any part of the Project except as expressly permitted under these Terms or with our prior written consent</li>
    <br/>
    <li>Confidentiality: You agree to keep confidential and not to disclose any confidential information or trade secrets of ours, including without limitation, the design of the Project, source code, documentation, and any other information or materials that are marked or otherwise identified as confidential (&quote; Confidential Information). You agree to use the Confidential Information solely for the purposes of the Project and not for any other purpose without our prior written consent</li>
    <br/>
    <li>Payment: You agree to pay us the agreed-upon fee for the design and development of the Project. The payment terms will be set forth in a separate agreement between you and us</li>
    <br/>
    <li>Warranties: You represent and warrant that you have the legal right and authority to enter into these Terms and to perform your obligations under these Terms. You further represent and warrant that the Project does not infringe upon the intellectual property rights of any third party</li>
    <br/>
    <li>Limitation of Liability: You acknowledge that we will not be liable for any indirect, incidental, special, consequential, or punitive damages arising out of or relating to these Terms or the Project, whether or not we have been advised of the possibility of such damages.</li>
    <br/>
    <li>Indemnification: You agree to indemnify and hold us harmless from and against any and all claims, damages, liabilities, costs, and expenses including reasonable attorneys fees arising out of or relating to your breach of these Terms or your use of the Project</li>
    <br/>
    <li>Termination: These Terms will remain in effect until the completion of the Project or until terminated by either party upon written notice to the other. Upon termination, you will immediately cease all use of the Project and return all Confidential Information to us</li>
    <br/>
    <li>Governing Law: These Terms will be governed by and construed in accordance with the laws of Kenya without giving effect to any choice or conflict of law provision or rule.</li>
    <br/>
    <li>Entire Agreement: These Terms constitute the entire agreement between you and us with respect to the Project and supersede all prior or contemporaneous communications and proposals, whether oral or written, between you and us</li>
</ul>
</Typography>
</Box>
<Typography variant="h4" color="black"  fontFamily="serif" >2. Cookies </Typography>
<Box sx={{marginLeft:9}}>
<Typography variant="h6" color="text.secondary" fontFamily="serif">
...
<br/><br/><br/>
<Typography variant="h4" color="black"  fontFamily="serif">3. Collection of general data and Information</Typography>
<Box sx={{marginLeft:9}}><Typography variant="h6" color="text.secondary" fontFamily="serif">(a) The website of BIT collects a series of general data and information when a data subject or automated system calls up the website. This general data and information are stored in the server log files. Collected may be (1) the browser types and versions used, (2) the operating system used by the accessing system, (3) the website from which an accessing system reaches our website (so-called referrers), (4) the sub-websites, (9) the date and time of access to the Internet site, (6) an Internet protocol address (IP address), (7) the Internet service provider of the accessing system, and (8) any other similar data and information that may be used in the event of attacks on our information technology systems.</Typography></Box>
<br/>
<Box sx={{marginLeft:9}}><Typography variant="h6" color="text.secondary" fontFamily="serif">(b) When using these general data and information, the Controller does not draw any conclusions about the data subject. Rather, this information is needed to (1) deliver the content of our website correctly, (2) optimize the content of our website as well as its advertisement, (3) ensure the long-term viability of our information technology systems and website technology, and (4) provide law enforcement authorities with the information necessary for criminal prosecution in case of a cyber-attack. Therefore, the Controller analyzes anonymously collected data and information statistically, with the aim of increasing the data protection and data security of our enterprise, and to ensure an optimal level of protection for the personal data we process. The anonymous data of the server log files are stored separately from all personal data provided by a data subject</Typography></Box>
<br/><br/><br/><br/>
<Typography variant="h4" color="black"  fontFamily="serif">4. Our Service</Typography>
<Box sx={{marginLeft:9}}><Typography variant="h6" color="text.secondary" fontFamily="serif">The Service allows you to discover, watch and share videos and other content, provides a forum for people to connect, inform, and inspire others across the globe, and acts as a distribution platform for original content creators and advertisers large and small. We provide lots of information about our products and how to use them in our Help Center. Amongst other things, you can find out about BIT Kids, the BIT Partner Program and BIT Paid Memberships and Purchases. You can also read all about enjoying content on other devices like your television, your games console, or even Google Home.</Typography></Box>
<br/><br/><br/><br/>
<Typography variant="h4" color="black" fontFamily="serif">5. Your Service Provider</Typography>
<Box sx={{marginLeft:9}}><Typography variant="h6" color="text.secondary" fontFamily="serif">The entity providing the Service is Google LLC, a company operating under the laws of Delaware, located at 1600 Amphitheatre Parkway, Mountain View, CA 94043 referred to as BIT, we, us, or our.  References to BIT Affiliates in these terms means the other companies within the Alphabet Inc. corporate group.</Typography></Box>
<br/><br/><br/><br/> 
<Typography variant="h4" color="black"  fontFamily="serif">6. Applicable Terms</Typography>
<Box sx={{marginLeft:9}}><Typography variant="h6" color="text.secondary" fontFamily="serif">Your use of the Service is subject to these terms, the BIT Community Guidelines and the Policy, Safety and Copyright Policies together, the Agreement. Your Agreement with us will also include the Advertising on BIT Policies if you provide advertising or sponsorships to the Service or incorporate paid promotions in your Content.</Typography></Box>
<br/>
<Box sx={{marginLeft:9}}><Typography variant="h6" color="text.secondary">Please read this Agreement carefully and make sure you understand it. If you do not understand the Agreement, or do not accept any part of it, then you may not use the Service</Typography></Box>
<Typography variant="h4" color="black"  fontFamily="serif">7. Who may use BIT?</Typography>
<Typography variant="h6" color="text.secondary">(a) Age requirement</Typography>
...
<br/><br/><br/>
<Typography variant="h6" color="black"  fontFamily="serif">(b) Permission by Parent or Guardian</Typography>
...
<br/><br/><br/>
<Typography variant="h4" color="black"  fontFamily="serif">8. Businesses</Typography>
...
<br/><br/><br/>
<Typography variant="h4" color="black"  fontFamily="serif">11. Reservation</Typography>
...
<br/><br/><br/>
<Typography variant="h4" color="black"  fontFamily="serif">12. Develop, Improve and Update the Service</Typography>
...
<br/><br/><br/>
<Typography variant="h4" color="black" fontFamily="serif">13. Your Content and Conduct</Typography>
<Typography variant="h6" color="text.secondary"  fontFamily="serif">(a) Uploading Content</Typography>
...
<Typography variant="h6" color="black"  fontFamily="serif">(b) Rights you Grant</Typography>
<Box sx={{marginLeft:5}}><Typography variant="h6" color="text.secondary" fontFamily="serif">You retain all of your ownership rights in your Content. In short, what belongs to you stays yours. However, we do require you to grant certain rights to BIT and other users of the Service, as described below.</Typography></Box>
<Typography variant="h6" color="black"  fontFamily="serif">(C) Licence to BIT</Typography>
...
<br/><br/><br/>
<Typography variant="h4" color="black"  fontFamily="serif">14. Removal of Content By BIT</Typography>
...
<br/><br/><br/>
<Typography variant="h4" color="black"  fontFamily="serif">15. Copyright Protection</Typography>
...
<br/><br/><br/>
<Typography variant="h4" color="black"  fontFamily="serif">16. Downloadable Software</Typography>
<Box sx={{marginLeft:5}}><Typography variant="h6" color="text.secondary" fontFamily="serif">When the Service requires or includes downloadable software (such as the BIT Studio application), unless that software is governed by additional terms which provide a licence, BIT gives you a personal, worldwide, royalty-free, non-assignable and non-exclusive licence to use the software provided to you by BIT as part of the Service. This licence is for the sole purpose of enabling you to use and enjoy the benefit of the Service as provided by BIT, in the manner permitted by this Agreement. You are not allowed to copy, modify, distribute, sell, or lease any part of the software, or to reverse-engineer or attempt to extract the source code of that software, unless laws prohibit these restrictions or you have BIT’s written permission</Typography></Box>
<br/><br/><br/>
<Typography variant="h4" color="black"  fontFamily="serif">17. Warranty</Typography>
<Box sx={{marginLeft:5}}><Typography variant="h6" color="text.secondary" fontFamily="serif">We provide the Service with reasonable care and skill</Typography></Box>
<br/><br/><br/>
<Typography variant="h4" color="black"  fontFamily="serif">18. Disclaimer</Typography>
<Box sx={{marginLeft:5}}><Typography variant="h6" color="text.secondary" fontFamily="serif">By law, consumers have certain rights that cannot be excluded or altered by a contract. Nothing in this Agreement affects those rights you may have as a consumer. Other than as expressly stated in this Agreement or as required by law, BIT does not make any specific promises about the Service. For example, we don’t make any promises about: the Content provided through the Service; the specific features of the Service, or its accuracy, reliability, availability, or ability to meet your needs; or that any Content you submit will be accessible or stored on the Service.</Typography></Box>
<br/><br/><br/>
<Typography variant="h4" color="black"  fontFamily="serif">19. Third Party Links</Typography>
<Box sx={{marginLeft:5}}><Typography variant="h6" color="text.secondary" fontFamily="serif">The Service may contain links to third-party websites and online services that are not owned or controlled by BIT. BIT has no control over, and assumes no responsibility for, such websites and online services. Be aware when you leave the Service; we suggest you read the terms and privacy policy of each third-party website and online service that you visit.</Typography></Box>
<br/><br/><br/>
<Typography variant="h4" color="black"  fontFamily="serif">20. About this Agreement</Typography>
<Box sx={{marginLeft:5}}><Typography variant="h6" color="text.secondary" fontFamily="serif">If we materially change this Agreement, we’ll provide you with reasonable advance notice and the opportunity to review the changes, except (1) when we launch a new product or feature, or (2) in urgent situations, such as preventing ongoing abuse or responding to legal requirements. If you don’t agree to the new terms, you should remove any Content you uploaded and stop using the Service.</Typography></Box>
<br/><br/><br/>
...
<Box sx={{
  ...
  src="https://play-lh.googleusercontent.com/xbGT908pv88eb0J9ZirsNEf0G35BEEhcON_wfKaMogVXMbqVlWPFCe73ZnwWY94o7mQ"sx={{ width: 150, height: 150 }}/>
        ...
        <Box sx={{marginLeft:5}}><Typography variant="h6" color="white">Sponsorship</Typography></Box>
          ...
          <div>
            <Typography variant="h4" color="white" fontFamily="serif">
              Reach us
            </Typography>
            <List>
              {[
