  ...
  const drawer = (
    <div>
      ...
      <List sx={{ color: "#A4A4A4" }}>
        ...
        {/* Favorites btn */}
        <ListItem disablePadding>
          <ListItemButton onClick={() => router.push("/favorites")}>
            <ListItemIcon>
        ...
        <ListItem disablePadding>
          <ListItemButton>
            <ListItemIcon>
              <Avatar
                alt="joe smith"
                src="https://images.pexels.com/photos/5615665/pexels-photo-5615665.jpeg?auto=compress&cs=tinysrgb&w=600"
                sx={{ height: 31, width: 31 }}
              />
            </ListItemIcon>
      ...
      >
        ...
        <Box
          sx={{
            ...
            width: "100%",
            backgroundImage:
              "url(https://images.unsplash.com/photo-1616530940355-351fabd9524b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8bW92aWVzfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60)",
        ...
        >
          <Box
            sx={{
              ...
              opacity: 0.78,
              backgroundImage:
                "linear-gradient(to right top, #0f0f11, #0d1113, #0b1313, #0d1411, #12140d)",
            }}
          ></Box>
          <Box sx={{ zIndex: 100, position: "absolute" }}>
            <Typography
              variant="h1"
              sx={{ color: "white", fontWeight: "bold", p: 4 }}
            >
              Enjoy your videos
            </Typography>
            <Typography
              variant="subtitle1"
              sx={{ color: "white", pl: 4, pr: 10, fontSize: 25 }}
            >
              Join a million of movie streams around the world. Enjoy your
              latest videos Shorts, Pranks, Comedies, Animation, Seires and
              movie, plus other networks of your will.
            </Typography>
          </Box>
        </Box>{" "}
